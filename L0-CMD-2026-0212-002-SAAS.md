...
1.2 Objective
  Build the multi-tenant SaaS platform with working frontend + backend.
  The SaaS app itself IS the demo for the 1:00 PM Saint-Gobain meeting
  with Nicole Calpin — no separate standalone HTML file needed.
  The frontend (React+Vite) serves the 3D viewer directly.
...
PHASE 1: SAAS PROJECT STRUCTURE (20 min)
───────────────────────────────────────────────────────────────────────────────────────────
...
PHASE 2: BACKEND — EXPRESS API WITH TENANT ISOLATION (45 min)
───────────────────────────────────────────────────────────────────────────────────────────
...
PHASE 3: FRONTEND — REACT + VITE SAAS APP (60 min)
───────────────────────────────────────────────────────────────────────────────────────────
...
4.3 3D Viewer (core feature)
  - Three.js scene with OrbitControls
  - Load detail + layers from API
  - Layer sidebar with toggles (data-driven from backend)
...
PHASE 5: COMMIT, PUSH, VERIFY (10 min)
───────────────────────────────────────────────────────────────────────────────────────────
...
Exit Criteria: Code pushed, dev instructions in README.
...
(Seeded into backend database and rendered by frontend viewer)
